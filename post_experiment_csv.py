...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  # Generate CSV with all attempts (auto-detect *.dag files, default output: job_output.csv)
  ...
  python post_experiment_csv.py output.csv --dag-files file1.dag file2.dag
        """
    )

    parser.add_argument("output_file", nargs="?", default="job_summary.csv", help="Output CSV file path (default: job_summary.csv)")
